<template>
  <l-map ref="map" @dblclick="onMapClick" :zoom="zoom"
    ...
    <l-geosearch :options="geoSearchOptions" class="geosearch-class"></l-geosearch>

    <l-marker v-if="position.lat && position.lng" visible draggable :icon="icon" :lat-lng.sync="position"
...
<script>
import { LMap, LMarker, LTileLayer, LTooltip, LControlLayers } from "vue2-leaflet";
